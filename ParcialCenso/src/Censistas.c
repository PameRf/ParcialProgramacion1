...
int cargaForzadaDeCensistas(Censistas* list){
	...
	Censistas censistaAux[6] = {{1001, "Juan", "Martinez",34, {23,2,1997},{"Montevideo",1433}, 2},
	           {1002, "Roberto", "Gomez", 25, {4 ,3 ,1995},{"Diaz Velez",1346}, 2},
				{1003, "Ezequiel", "Freire", 36, {28, 4, 1987},{"Viamonte",1568}, 2},
	            {1004, "Dario", "Gomez",28, {14, 12, 1993},{"Callao",2345}, 2},
