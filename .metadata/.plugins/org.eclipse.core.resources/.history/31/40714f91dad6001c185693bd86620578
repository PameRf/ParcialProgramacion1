...
void mostrarUnCensista(Censistas unCensista){
	...
	printf("%-4d %-15s %-19s %-10d %d/%d/%d %10s %d %-4d\n", unCensista.idCensista,  unCensista.nombre, unCensista.apellido, unCensista.edad, unCensista.fecha.dia, unCensista.fecha.mes,unCensista.fecha.anio, unCensista.domicilio.calle,unCensista.domicilio.numero,unCensista.estado);
